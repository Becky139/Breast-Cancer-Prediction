...
def page_summary_body():
    ...
    st.markdown(
        "* The dataset is on kaggel it is publicly available so it does not require a license to use. Each row represents a person and the columns have differant signs or textures of tumours. The dataset contains ** 569 samples of malignant and benign tumor cells**.\n"
