...
def page_data_anaylsis_body():
    ...
    st.markdown(
        ...
        done before any modelling. This is because it is very important for a \
    ...
    st.markdown(
        ...
        including pre-processing, modelling, and interpretation of results."
    )
    ...
    st.markdown(
        ">The skew result shows a positive (right) or negative (left) skew. \
    ...
    # let’s get the frequency of cancer diagnosis
    st.image("outputs/nb2/diagnosis.jpeg")

    st.markdown(
        "Check binary encoding from NB1 to confirm the conversion of the \
        diagnosis categorical data into numeric, where"
    )
    st.markdown("* Malignant = 1 (indicates presence of cancer cells)")
    st.markdown("* Benign = 0 (indicates absence)")
    ...
    st.markdown("Lets confirm this, by plotting the histogram")
    ...
    st.markdown(
        "Separate columns into smaller data frames to perform visualization. \
    ...
    st.info("### Histogram the _mean suffix designation")

    # Plot histograms of _mean variables
    st.image("outputs/nb2/hist_mean.jpeg")

    st.info("### Histogram for  the _se suffix designation")

    # Plot histograms of _se variables
    st.image("outputs/nb2/hist_se.jpeg")

    st.info("### Histogram _worst suffix designation")
    ...
    st.info('### Density plots "_mean" suffix designation')

    # Density Plots
    st.image("outputs/nb2/density_mean.jpeg")

    st.info('### Density plots "_se" suffix designation')

    # Density Plots
    st.image("outputs/nb2/density_se.jpeg")

    st.info('### Density plot "_worst" suffix designation')
    ...
    st.info('### Box plot "_mean" suffix designation')

    # box and whisker plots
    st.image("outputs/nb2/boxplot_mean.jpeg")

    st.info('### Box plot "_se" suffix designation')

    # box and whisker plots
    st.image("outputs/nb2/boxplot_se.jpeg")

    st.info('### Box plot "_worst" suffix designation')
    ...
    st.markdown(
        " * Some parameters are moderately positive correlated (r between \
    ...
    st.markdown(
        ...
        concavity and concave points can be used in the classification of the \
        cancer. Larger values of these parameters tend to show a correlation\
    ...
    st.markdown(
        ...
        that warrants further clean-up."
    )
    ...
    st.markdown(
        ...
        could be argued based on the basis of the scree plot that the first \
        three components should be retained."
    )

    st.success("### A Summary of the Data Pre-processing Approach used here:")
